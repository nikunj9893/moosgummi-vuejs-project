<template>
   <div>
      ...
      <CCard class="card-border-top">
                     ...
                     <CCol lg-2>
                        <div class="m-3">
                           <input
                              ...
                              v-model="updateText"
                           />
                           <label for="update" class="font-weight-bold"
                              >Update Tax</label
                           >
                        </div>
                     </CCol>
                  ...
                  <CRow class="mt-4">
                     <CCol lg-3>
                        <label class="font-weight-bold"
                           >Supply Date From:</label
                        >
                        <CInput
                           type="date"
                           v-model="formData.supply_date_from"
                        />
                     </CCol>
                     <CCol lg-3>
         ...
         <CRow>
            <CButton @click="save" class="m-2 ml-5" color="primary"
               >Save</CButton
            >

            <CButton class="m-2" color="secondary" @click="cancel"
               >Cancel</CButton
            >
         </CRow>
      </CCard>
