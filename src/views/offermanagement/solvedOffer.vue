          ...
          <tr v-for="item in datas" :key="item.id">
            ...
            <td class="p-0 align-middle">
              <div class="btn-group" role="group" aria-label="First group">
                <button type="button" class="btn btn-primary" @click="manageOffer(item.id)">
                  <i class="cil-search" color="white"></i>
                </button>
                <button type="button" class="btn btn-primary" @click="downloadOffer(item.id)">
                  <i class="cil-cloud-download"></i>
                </button>
                <button type="button" class="btn btn-primary" @click="markOfferAsSent(item.id)">
                  <i class="cil-send"></i>
                </button>
                <button type="button" class="btn btn-success" @click="markAsAccept(item.id)">
                  <i class="cil-check"></i>
                </button>
                <button type="button" class="btn btn-danger" @click="markRejected(item.id)">
